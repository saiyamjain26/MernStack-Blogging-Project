...
function Posts() {
  ...
  return (
    <InfiniteScroll
      ...
      endMessage={
        posts.length && (
          <p style={{ textAlign: "center", marginTop: "50px", fontFamily:"monospace" }}>
            <b>Stay tuned for upcoming blogs, or feel free to dive into our archives for a wealth of knowledge and inspiration.</b>
          </p>
        )
      }
    >
